    ...
    <>
      <div className="bg-slate-500 flex flex-row">
        <div className="basis-1/3 m-4 w-52 min-h-[640px] bg-slate-100 border-2 border-slate-100 rounded-lg flex-column items-top justify-center ">
          ...
          <ul className="flex flex-col items-center justify-center">
            <li className="inline-flex ">
              <CustomButton
                tip="navigate"
                location="/mainpage/prev1"
                className="mr-8 border-2 bg-blue-200 rounded-lg text-lg pt-1 pb-1 pl-2 pr-2"
              >
                Cristi CV
              </CustomButton>
              <CustomButton
            ...
            <li className="inline-flex ">
              <CustomButton
                tip="navigate"
                location="/mainpage/prevTudor"
                className="mt-4 mr-8 border-2 bg-blue-200 rounded-lg text-lg pt-1 pb-1 pl-2 pr-2"
              >
                Tudor CV
              </CustomButton>
              <CustomButton
                tip="prev"
                className="mt-4 mr-8 border-2 bg-blue-200 rounded-lg pt-1 pb-1 pl-2 pr-2"
                onCustomClick={() => setShowf(true)}
              >
                preview
              </CustomButton>
        ...
        <div className="basis-2/3 m-4 w-52 min-h-[640px] bg-slate-100 border-2 border-slate-100 rounded-lg flex items-center justify-center">
          {Showf && (
            <iframe src="/mainpage/prevTudor" width="95%" height="600px"></iframe>
          )}
        </div>
      </div>
    </>
